        ...
        <View style={styles.instantMatchContainer}>
          <View style={styles.centerContainer}>
            <BlurView style={styles.instantMatchForm} intensity={50}>
              <Text style={styles.title}>Upcoming Match Details</Text>
              ...
              <View style={styles.inputContainer}>
                ...
                <View style={styles.inputField}>
                  ...
                  <View style={styles.inputWrapper}>
                    <Icon name="event" size={24} color="#888" style={styles.inputIcon} />
                    <TouchableOpacity
                      style={styles.input}
                ...
                <View style={styles.inputField}>
                  ...
                  <View style={styles.inputWrapper}>
                    <Icon name="access-time" size={24} color="#888" style={styles.inputIcon} />
                    <TouchableOpacity
                      style={styles.input}
                      onPress={() => setShowStartTimePicker(true)}
                    >
                      <Text style={styles.placeholderText}>
                        {startTime ? moment(startTime).format("HH:mm") : "Start Time"}
                      </Text>
                    </TouchableOpacity>
              ...
              <Text
                ...
                style={styles.instantMatch}
              >
                Schedule an instant match
              </Text>
