              ...
              <View style={styles.dateLocationRow}>
                ...
                <Text style={styles.dateLocationText}>
                  {tournamentDetails.startDate
                    ? moment(new Date(tournamentDetails.startDate[0], tournamentDetails.startDate[1], tournamentDetails.startDate[2])).format('MMM DD, YYYY')
                    : 'N/A'}
                  {' - '}
                  {tournamentDetails.endDate
                    ? moment(new Date(tournamentDetails.endDate[0], tournamentDetails.endDate[1], tournamentDetails.endDate[2])).format('MMM DD, YYYY')
                    : 'N/A'}
                </Text>
              </View>
              <View style={styles.dateLocationRow}>
